...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'Pressed') {
			...
			var i = _v1.a;
			var j = _v1.b;
			if ($elm$core$List$length(model.queue) === 6) {
				var _v2 = model.queue;
				if (_v2.b) {
					var hd = _v2.a;
					var tl = _v2.b;
...
var $author$project$Main$view = function (model) {
	var panelSize = 50;
	var panelMaker = function (_v8) {
		var i = _v8.a;
		var j = _v8.b;
		var panelAttributes = _List_fromArray(
			[
				$elm$svg$Svg$Attributes$x(
				$elm$core$String$fromInt(i * panelSize)),
				$elm$svg$Svg$Attributes$y(
				$elm$core$String$fromInt(j * panelSize)),
				$elm$svg$Svg$Attributes$width(
				$elm$core$String$fromInt(panelSize)),
			...
			A2(
				...
				$elm$svg$Svg$Events$onClick(
					$author$project$Main$Pressed(
						_Utils_Tuple2(i, j))),
				panelAttributes),
			_List_Nil) : A2($elm$svg$Svg$rect, panelAttributes, _List_Nil);
	};
	var panelList = A2(
		$elm$core$List$map,
		panelMaker,
		$elm$core$List$concat(
			A2(
				...
				A2($elm$core$List$range, 0, $author$project$Main$fieldSize - 1))));
	var mxStr = $elm$core$String$fromInt(panelSize * $author$project$Main$fieldSize);
	var margin = 5;
	var oxMaker = function (_v7) {
		var i = _v7.a;
		var j = _v7.b;
		var _v4 = A2(
			$elm$core$Dict$get,
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(((panelSize / 2) | 0) + (i * panelSize))),
								$elm$svg$Svg$Attributes$cy(
								$elm$core$String$fromInt(((panelSize / 2) | 0) + (j * panelSize))),
								$elm$svg$Svg$Attributes$r(
								$elm$core$String$fromInt(((panelSize / 2) | 0) - margin)),
								$elm$svg$Svg$Attributes$fill('#ffffff'),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt((i * panelSize) + margin)),
								$elm$svg$Svg$Attributes$y1(
								$elm$core$String$fromInt((j * panelSize) + margin)),
								$elm$svg$Svg$Attributes$x2(
								$elm$core$String$fromInt(((i + 1) * panelSize) - margin)),
								$elm$svg$Svg$Attributes$y2(
								$elm$core$String$fromInt(((j + 1) * panelSize) - margin)),
								$elm$svg$Svg$Attributes$strokeWidth('4'),
	...
	var svgList = $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			oxMaker,
			$elm$core$List$concat(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$width(mxStr),
						$elm$svg$Svg$Attributes$height(mxStr),
						$elm$svg$Svg$Attributes$viewBox('0 0 ' + (mxStr + (' ' + mxStr)))
					]),
				_Utils_ap(panelList, svgList)),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(gameOverString)
					])),
				continueButton
			]));
};
